...
curl -L -o openpnp-capture/binaries/darwin-x86-64/libopenpnp-capture.dylib https://github.com/openpnp/openpnp-capture/releases/download/$1/libopenpnp-capture.dylib
